...
import { User, Mail, Phone, MapPin, Calendar, Edit, Save, X, Heart, Plane } from "lucide-react";
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600">Manage your travel profile and preferences</p>
            </div>
            ...
            <div className="md:col-span-2">
              ...
              <div className="relative">
                ...
                <textarea
                  ...
                  disabled={!isEditing}
                  rows={3}
                  placeholder="e.g., Adventure tours, cultural experiences, wildlife safaris..."
                  className="w-full pl-10 pr-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 disabled:bg-gray-50 disabled:text-gray-500"
                />
              </div>
            </div>
