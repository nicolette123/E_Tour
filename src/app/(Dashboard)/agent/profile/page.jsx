...
import { User, Mail, Phone, MapPin, Calendar, Edit, Save, X, Award, Users } from "lucide-react";
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600">Manage your travel agent information</p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="md:col-span-2 flex items-center space-x-6 pb-6 border-b border-gray-200">
              ...
              <div>
                ...
                <p className="text-gray-600">Travel Agent</p>
            ...
            <div className="md:col-span-2">
              ...
              <input
                ...
                onChange={handleInputChange}
                disabled={!isEditing}
                placeholder="e.g., 5 years in tourism industry"
                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 disabled:bg-gray-50 disabled:text-gray-500"
              />
            </div>
            ...
            <div className="md:col-span-2">
              ...
              <textarea
                ...
                rows={4}
                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 disabled:bg-gray-50 disabled:text-gray-500"
                placeholder="Tell us about your experience and what makes you a great travel agent..."
              />
            </div>
          </div>
        </div>
