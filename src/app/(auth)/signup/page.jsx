...
const UserRegister = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        // Validate agent fields if isAgent is true
        ...
        try {
            console.log('Submitting registration with payload:', {
                ...
                role: formData.role,
                companyName: formData.isAgent ? formData.companyName : undefined,
                location: formData.isAgent ? formData.location : undefined
            });
            const response = await post('https://echoes-of-rwanda.onrender.com/api/v1/auth/register', {
                name: formData.name,
                email: formData.email,
                password: formData.password,
                notificationsEnabled: formData.receiveNotifications,
